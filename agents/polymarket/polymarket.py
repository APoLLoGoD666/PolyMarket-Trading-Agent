...
class Polymarket:
    def __init__(self) -> None:
        ...
        self.proxy_wallet_address = "0x979fc044ef825159e61ec60eb4adef1bcddab8a2"
        ...
        for token_address, label in [
            ...
            try:
                ...
                if raw > 0:
                    ...
                    print(f"USDC balance ({label}): ${balance:.2f}")
                    return balance
            except Exception as e:
                print(f"Balance check failed for {label}: {e}")
        print("WARNING: USDC balance is $0.00 on both native USDC and USDC.e contracts")
        return 0.0
